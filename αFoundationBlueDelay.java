...
@Autonomous(name = "IMUFoundBlueDelay", group = "Autonomous")
public class αFoundationBlueDelay extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        r.fServo2.setPosition(0.5);//deploy the servo
        sleep(600);
