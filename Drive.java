...
/**
 * Created by sarahchen: Skystone drive code
 */
@TeleOp(name="Drive1", group="Autonomous")
@Disabled
public class Drive extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        CapServo = hardwareMap.servo.get("CowCap");
...
//        rotMotor.setDirection(DcMotor.Direction.REVERSE);
